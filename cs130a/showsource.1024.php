...
if (file_exists("$filename") && ereg("[^/\\]", $filename)) {
  ...
  numbers($filename, $numbers);

  print "<blockquote" . cite($filename) . "><pre>\n";
  show($filename, $numbers);
...
function show($filename, $numbers = false)
// Based on highlight_file_linenum by Aidan Lister
...
function numbers($filename, $numbers)
{
